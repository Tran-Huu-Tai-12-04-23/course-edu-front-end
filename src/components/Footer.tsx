    ...
    return (
        <footer className="bg-blue-100/80 font-sans dark:bg-gray-900">
            <div className="container px-6 py-12 mx-auto">
                ...
                <p className="font-sans p-8 text-start md:text-center md:text-lg md:p-4 mb-20">
                    © 2024 Course EDU nền tảng học tập trực tuyến. Kho tài liệu và khóa học khổng lồ
                </p>
            </div>
        </footer>
    );
